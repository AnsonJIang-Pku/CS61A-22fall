...
def tail_points(opponent_score):
    ...
    opponent_score //= 10
    sec_rightmost = opponent_score % 10
    return 2 * abs(rightmost - sec_rightmost) + 1
    # END PROBLEM 2
...
def play(strategy0, strategy1, update,
    ...
    while True:
        ...
        if who == 0:
            ...
            score0 = update(num_of_dice, score0, score1, dice)
            who = 1 - who
        elif who == 1:
            num_of_dice = strategy1(score1, score0)
            score1 = update(num_of_dice, score1, score0, dice)
            who = 1 - who
    # END PROBLEM 5
...
def always_roll(n):
    ...
    assert n >= 0 and n <= 10
    # BEGIN PROBLEM 6
    def h_strategy(score, oppo_score):
        return n 
    return h_strategy
    # END PROBLEM 6
...
def square_strategy(score, opponent_score, threshold=12, num_rolls=6):
    ...
    # BEGIN PROBLEM 11
    delta = square_update(0, score, opponent_score) - score
    if delta >= threshold:
        return 0
    else:
        return num_rolls
