#I don't know how to figure out div_by_primes_under(n) (Question5) by now.
...
# cd Desktop/cs61a\ \(22fall\)/Labs/lab03
...
def div_by_primes_under(n):
    ...
    while i <= n:
        if not checker(i):
            #how to figure this function out????
...
#Kaze: carefully examine the meaning of church_to_int()'s argument.
def add_church(m, n):
